...
public:
	...
	{
		assert(mLength > 0);
		return mFunctionStack[mLength-1];
	}
...
public:
	void enter(ir.Module m) { assert(current is null); push(m, m.myScope, null); }
	...
	void enter(ir.BlockStatement bs) { current = bs.myScope; }
	...
	void leave(ir.BlockStatement bs) { current = current.parent; }
